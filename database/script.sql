...
ALTER TABLE HISTORIAL_PRECIO ADD CONSTRAINT HISTORIAL_PRECIO_pk PRIMARY KEY ( id_historial_precio );
...
ALTER TABLE HISTORIAL_PRECIO
    ADD CONSTRAINT HISTORIAL_PRECIO_PRODUCTO_fk FOREIGN KEY ( PRODUCTO_id_producto )
...
--Insertar empleados
INSERT INTO EMPLEADO(nombre,salario) VALUES('Eren Jeager',1000.50);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Mikasa Akerman',1500.75);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Armin Arlet',2500);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Levi Ackerman',3000);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Erwin Smith',4000);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Sasha Blouse',2000);
INSERT INTO EMPLEADO(nombre,salario) VALUES('Reiner Braun',2000);
